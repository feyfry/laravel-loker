...
@section('title', 'Create Lowongan Pekerjaan')
...
<div class="py-4">
    <nav aria-label="breadcrumb" class="d-none d-md-inline-block">
        <ol class="breadcrumb breadcrumb-dark breadcrumb-transparent">
            ...
            <li class="breadcrumb-item active" aria-current="page">Create Loker</li>
        </ol>
    </nav>
    <div class="d-flex justify-content-between w-100 flex-wrap">
        <div class="mb-3 mb-lg-0">
            <h1 class="h4">Create Loker</h1>
            <p class="mb-0">Tambah Data Lowongan Pekerjaan</p>
        </div>
        <div>
...
<div class="card border-0 shadow mb-4">
    <div class="card-body">
        <form method="POST" action="{{ route('panel.loker.store') }}">
            @csrf
            ...
            <div class="mb-3">
                ...
                <div class="input-group">
                    ...
                    <input type="number" name="salary_range_min" id="salary_range_min"
                        ...
                        value="{{ old('salary_range_min') }}" placeholder="Min">
                    ...
                    <input type="number" name="salary_range_max" id="salary_range_max"
                        ...
                        value="{{ old('salary_range_max') }}" placeholder="Max">
                </div>
            ...
            <div class="mb-3">
                ...
                <textarea name="questions" id="questions" cols="30" rows="10"
                    class="form-control @error('questions') is-invalid @enderror">{{ old('questions') }}</textarea>
