            ...
            <ul class="navbar-nav align-items-center">
                ...
                <li class="nav-item dropdown ms-lg-3">
                    ...
                    <div class="dropdown-menu dashboard-dropdown dropdown-menu-end mt-2 py-1">
                        <a class="dropdown-item d-flex align-items-center" href="{{ route('panel.profile.edit') }}">
...
function loadNotifications() {
    $.get('/panel/notifications/unread', function(data) {
    ...
    $.get('/panel/notifications/latest', function(data) {
        ...
        notifications.forEach(notification => {
            container.append(`
                <a href="#" class="list-group-item list-group-item-action border-bottom ${notification.is_read ? '' : 'unread'}">
...
// Memperbarui notifikasi setiap 1 detik
