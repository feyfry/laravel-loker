...
Terima kasih telah melamar posisi **{{ $lamaran->jobdesc->position }}** di **{{ $lamaran->jobdesc->company_name }}**. Kami sangat menghargai waktu dan minat Anda untuk menjadi bagian dari tim kami. Saat ini, status lamaran Anda masih {{ $lamaran->status }}.
